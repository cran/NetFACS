...
#'
#' @return Function returns a data frame with each combination, the reciprocity of conditional occurrence from -1 (one element entirely depends on the other, but not vice versa) to 1 (both elements always occur together)
#' @return The directions and conditional probabilities of both elements are also returned
#' @export
#' @examples
